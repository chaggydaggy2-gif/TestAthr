...
const PRE_ASSESSMENT_SECTIONS = [
  ...
  },
  {
    ...
    questions: [
      { id: 'snd_r',  label: 'حرف (ر) — رجل، عروس، سرير', cat: 'sounds', goal: 'r' },
      { id: 'snd_th', label: 'حرف (ث) — ثعبان، كمثرى، مثلث', cat: 'sounds', goal: 'th' },
      { id: 'snd_dh', label: 'حرف (ذ) — ذيل، أذن', cat: 'sounds', goal: 'dh' },
      { id: 'snd_z',  label: 'حرف (ز) — زرافة، جزر، موز', cat: 'sounds', goal: 'z' },
      { id: 'snd_gh', label: 'حرف (غ) — غزال، مغسلة', cat: 'sounds', goal: 'gh' },
      { id: 'snd_kh', label: 'حرف (خ) — خيمة، مخدة، مطبخ', cat: 'sounds', goal: 'kh' },
      { id: 'snd_s',  label: 'حرف (س) — ساعة، كرسي، شمس', cat: 'sounds', goal: 's' },
      { id: 'snd_sh', label: 'حرف (ش) — شنطة، فرشة، مشمش', cat: 'sounds', goal: 'sh' },
      { id: 'snd_q',  label: 'حرف (ق) — قلم، مقص، صندوق', cat: 'sounds', goal: 'q' },
